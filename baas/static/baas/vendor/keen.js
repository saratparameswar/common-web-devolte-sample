...
!function(name, context, definition){
  ...
  */
  ...
  Keen.prototype.configure = function(config){
    ...
    config['host'] = (_isUndefined(config['host'])) ? 'localhost:8002' : config['host'].replace(/.*?:\/\//g, '');
  ...
  function _build_url(path) {
    return this.client.endpoint + '/emit'+ path;
  }
  ...
  function _uploadEvent(eventCollection, payload, success, error) {
    ...
    switch(this.client.requestType){
      ...
      case 'jsonp':
        ...
        // Write here the call to devolte like this 
        divolte.signal('myCustomEvent', jsonBody)
  ...
  */
  ...
  // Source: src/vendor/keen-dataform.js
// Source: src/vendor/_intro.js
...
(Keen, function() {
  ...
  Dataform.prototype.sort = function(opts){
    ...
    // Source: src/vendor/_outro.js
    return Dataform;
}));

  // Source: src/vendor/keen-domready.js
/*!
  * domready (c) Dustin Diaz 2012 - License MIT
  */
// Modified header to work internally w/ Keen vendor
/*!
  * domready (c) Dustin Diaz 2012 - License MIT
  */
(function(root, factory) {
  ...
  // Source: src/vendor/keen-spinner.js
/**
 * Copyright (c) 2011-2014 Felix Gnass
 * Licensed under the MIT license
 */
// Modified to work internally with Keen vendor
(function(root, factory) {
